...
export default function Accessibility() {
  return (
    <LegalShell title="Accessibility Statement" updated="June 2026">
      ...
      <p>We have taken the following steps to make this site accessible to everyone:</p>
      <ul>
        <li>
      ...
      <p>
        If you encounter any accessibility barrier on this site, please reach out and we will address
        it promptly. Call us at{' '}
